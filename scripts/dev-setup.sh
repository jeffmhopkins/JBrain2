...
# session shell (`@anthropic-ai/claude-code`, xAI's official Grok Build binary, and the
# `openclaw` npm CLI) and the on-box coder model — is provided by the jcode IMAGE
# (jcode/Dockerfile) and enabled
# SEPARATELY by
