...
callout([lock_xs[len(lock_xs) - 1] + 2, cav_y / 2 - 3, body_h], [26, 28, z], "lock blocks", "top", t, "left");
callout([lock_xs[len(lock_xs) - 1], head_y / 2, lock_z], [26, 23, z], "lock screw holes", "top", t, "left");
