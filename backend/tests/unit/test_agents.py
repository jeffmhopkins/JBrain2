...
def test_persona_prompts_pinned_to_their_versions() -> None:
    ...
    pins = {
        ...
        "jerv": (
            "agent-jerv-v44",
            "7598ef5e4445f01fc57612f8bb7097eb0c24d104c86702257956dbb9d6c5e32d",
        ),
        "archivist": (
            "agent-archivist-v6",
        ...
        "research_scout": (
            "agent-research-scout-v6",
            "55fc245d4762e9ce422851ee436e8d1b9532ef66441c808b956592db207ee057",
        ),
        "research_fetch": (
