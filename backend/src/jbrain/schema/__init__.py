...
The YAML files are the authoring surface (docs/reference/entity.md, decision 1); this
...
predicate-name validation never rejects (docs/reference/entity.md invariant); only a
