...
params:
  ...
  properties:
    slug:
      type: string
      description: The article slug from grokipedia_search (e.g. Elon_Musk).
  required: [slug]
---
...
the outline, then read only the section you need with grokipedia_section, passing either the
