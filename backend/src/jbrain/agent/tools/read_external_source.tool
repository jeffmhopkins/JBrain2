...
search_external when the best-matching excerpt isn't enough and you need the video's complete
content — to summarize the whole thing, answer a question that spans it, or pull a detail from a
part search didn't surface. Pass the video's URL (the same link a search_external result points
...
moment with search_external if you need more precision there.
