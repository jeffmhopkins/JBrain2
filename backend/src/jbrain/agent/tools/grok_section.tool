...
params:
  ...
  properties:
    ...
    section:
      type: string
      description: >-
        Which section to read — its number from grok_outline (e.g. "2.1") or its title
...
grok_outline), instead of loading the whole page. Returns that section's text as
...
truncated with a pointer to its sub-sections; drill in with grok_outline. This is the
