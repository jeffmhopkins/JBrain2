...
search_external_video has found which video they mean. Pass that video's URL.

Prefer read_external_video instead when the owner wants the CONTENT in words (to summarize or
