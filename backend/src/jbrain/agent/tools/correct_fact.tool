  ...
  properties:
    ...
    object:
      ...
      description: >-
        ...
        or the id of another entity when the right answer is a person or an organization.
        Not a description of what is wrong.
    statement:
      type: string
      description: >-
    ...
    replaces:
      type: string
      description: >-
        Only when a previous correct_fact answered with f1/f2 handles because the
        relation holds several values at once — the handle of the one that is wrong.
        An empty string otherwise.
  required: [entity, predicate, qualifier, object, statement, when, replaces]
examples:
...
no fact id to quote and you do not need one. If that address holds several live values
at once (someone owns three things, attended four schools), nothing is written and you
get f1/f2 handles back; call it again with `replaces` set to the one he says is wrong.
