"""The wiki-editorial WRITE tools (docs/plans/PHASE6_WIKI_PLAN.md §4): the sanctioned
levers the agent operates on the owner's behalf in Talk. The wiki stays machine-written
— these never edit prose;
