...
# heat_index_f lives in the shared heatindex module (both weather tools use the same NWS
# figure); re-exported here so this module's existing callers/import path keep working.
