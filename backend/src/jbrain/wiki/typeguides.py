"""Per-type editorial guides for the builder (the code projection of
docs/reference/WIKI_TYPE_GUIDES.md).
...
# The binding writing-style block (docs/reference/WIKI_TYPE_GUIDES.md "Writing style"). The
# hard rules (citation, single-domain, omit-empty) are enforced in code regardless; this
# steers the prose.
STYLE_PROMPT = (
