...
// tabs, locking the phone, or swapping apps — flips the Page Visibility API to
// "hidden", and a backgrounded app has no business holding the server busy.
// Every recurring poll consults this so it suspends while hidden and resumes
// (with an immediate catch-up) the moment the owner brings the app back.
