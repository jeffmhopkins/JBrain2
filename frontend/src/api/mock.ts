...
const LLM_SETTINGS: LlmSettings = {
  ...
  local_models: [
    ...
    },
    {
      ...
      disk_gb: null,
      download_gb: null,
      note: "30B MoE, 3B active — hybrid Mamba-2 + MoE reasoner at 8-bit. Only ~3B active per token, so fast even at Q8 (~50-65 t/s) with a tiny KV cache. Co-resides beside gpt-oss-120b.",
      context_window: 32768,
    ...
    },
    {
      ...
      disk_gb: null,
      download_gb: null,
      note: "Dense 27B (text + vision) hybrid reasoner at 8-bit. Bandwidth-bound here (~7 t/s) — prefer the Q4 twin for interactive use. Co-resides beside gpt-oss-120b.",
      context_window: 32768,
      max_context_window: 262144,
      context_window_override: null,
      parallel_slots: 1,
    ...
    },
    {
      ...
      disk_gb: null,
      download_gb: null,
      note: "Dense 27B (text + vision) hybrid reasoner at Q4_K_M — the interactive twin of the Q8 entry (~12-13 t/s). ~16 GB, co-resides beside gpt-oss-120b.",
      context_window: 32768,
      max_context_window: 262144,
      context_window_override: null,
      parallel_slots: 1,
