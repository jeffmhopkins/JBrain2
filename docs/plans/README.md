...
| `READ_ALOUD_AUDIOBOOK_PLAN.md` | **Scheduled** — audiobook-grade read-aloud on the on-box Kokoro engine: a two-layer text pipeline, misaki G2P + acronym/lexicon pronunciation, shaped silence/pacing, a blended narrator voice, and story-vs-answer modes. Single narrator; builds on `../archive/READ_ALOUD_LEGIBILITY.md`. W0–W4 open. |
